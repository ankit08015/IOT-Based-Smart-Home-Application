 ...
 * @author ajaygoel
 */
public class MarketWalletDetails extends javax.swing.JPanel {

    /**
     * Creates new form MarketWalletDetails
     */
    String name;
    Wallet wallet;
    ...
    MarketWalletDetails(String name, Wallet wallet, JPanel userProcessContainer) {
       initComponents();
